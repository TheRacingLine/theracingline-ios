        ...
        ScrollView {
            VStack {
                ...
                GroupBox {
                    ...
                    Group {
                        SettingsDescriptionView(text: "Permission is granted to temporarily download one copy of the materials (information or software) on TheRacingLine's website for personal, non-commercial transitory viewing only. This is the grant of a licence, not a transfer of title, and under this licence you may not:")
                        Divider().padding(.vertical, 4)
                        SettingsDescriptionView(text: "modify or copy the materials;")
                        Divider().padding(.vertical, 4)
                        SettingsDescriptionView(text: "attempt to decompile or reverse engineer any software contained on TheRacingLine's website;")
                        Divider().padding(.vertical, 4)
                        SettingsDescriptionView(text: "remove any copyright or other proprietary notations from the materials; or")
                        Divider().padding(.vertical, 4)
                        SettingsDescriptionView(text: "transfer the materials to another person or 'mirror' the materials on any other server.")
                        Group{
                            Divider().padding(.vertical, 4)
                ...
                GroupBox {
                    ...
                    Divider().padding(.vertical, 4)
                    SettingsDescriptionView(text: "Further, TheRacingLine does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on its website or otherwise relating to such materials or on any sites linked to this site.")
                } //GROUPBOX
                GroupBox {
                    Text("4. Limitations")
                        .font(.title3)
                ...
                GroupBox {
                    Text("6. Links")
                        ...
                        .fontWeight(.bold)
                        .padding(.bottom, 5)
                    SettingsDescriptionView(text: "TheRacingLine has not reviewed all of the sites linked to its website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by TheRacingLine of the site. Use of any such linked website is at the user's own risk.")
                } //GROUPBOX
                GroupBox {
                    Text("7. Modifications")
                        ...
                        .fontWeight(.bold)
                        .padding(.bottom, 5)
                    SettingsDescriptionView(text: "TheRacingLine may revise these terms of service for its website at any time without notice. By using this website you are agreeing to be bound by the then current version of these terms of service.")
                } //GROUPBOX
                GroupBox {
                    Text("8. Governing Law")
                        ...
                        .fontWeight(.bold)
                        .padding(.bottom, 5)
                    SettingsDescriptionView(text: "These terms and conditions are governed by and construed in accordance with the laws of United Kingdom and you irrevocably submit to the exclusive jurisdiction of the courts in that State or location.")
                } //GROUPBOX
